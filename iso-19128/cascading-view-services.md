...
* the 'cascade' attribute of the <wms:Layer> element is used to indicate that the layer is hosted by a remote View Service and the level of the cascade,
...
* [TG VS](http://inspire.ec.europa.eu/id/ats/view-service/3.11/iso-19128/README#ref_TG_VS), Chapter 4.2.5.3, Requirements 63, 64, 65
